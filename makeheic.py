...
if __name__ == '__main__':
    ...
    parser.add_argument('-q',type=int,required=False,help='Quality(crf), default 21.',default=21)
    ...
    for in_fp in args.INPUTFILE:
        ...
        heic = makeheic(in_fp,out_fp,args.q,args.delete_src,args.sws,args.alpha,args.no_alpha,args.no_icc,args.mat,args.depth,args.sample,pid)
        heic.make()
